package ru.practicum.shareit1.request.service;
...
class ItemRequestServiceTest {
    ...
    void createItemRequest() {
        ...
        assertEquals(itemRequestToSave, actualItemRequest);
    ...
    void getItemRequests() {
        ...
        assertEquals(itemRequestDtoListExpected, actualItemRequestListDto);
    ...
    void getItemRequestsAllOther() {
        ...
        assertEquals(itemRequestDtoListExpected.size(), actualItemRequestListDto.size());
    ...
    void getItemRequestById() {
        ...
        assertEquals(itemRequestToSave, ItemRequestMapper.INSTANCE.itemRequestDtoToItemRequest(actualItemRequestDto));
